        ...
        <div className="relative flex flex-col items-center justify-center w-full py-20">
            <Container>
                <div className="flex flex-col items-center text-center max-w-2xl mx-auto">
                    ...
                    <p className="text-zinc-500 md:text-lg text-center text-accent-foreground/80 mt-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-8 relative overflow-visible">
                {FEATURES.map((feature, index) => (
                    <Container key={feature.title} delay={0.1 + index * 0.1} className={cn(
                        "relative flex flex-col rounded-2xl lg:rounded-3xl bg-card transition-colors",
                        ...
                        >
                            <div className="flex items-center space-x-4 mb-4">
                                <h3 className="text-xl font-semibold flex items-center gap-2">
                                    <feature.icon className="text-white size-5 text-primary" />
                                    {feature.title}
                                </h3>
                            </div>
                            ...
                            <div className="mt-6 w-full bg-card/50 overflow-hidden bg-black">
                                <Image
                                    src={feature.image}
                                    alt={feature.title}
                                    width={500}
